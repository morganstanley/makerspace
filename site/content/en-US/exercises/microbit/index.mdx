...
## Sessions Included:
1. [Introduction to Micro:bit](/exercises/microbit/level-1)
2. [Basic Programming with Micro:bit](/exercises/microbit/level-2)
3. [Advanced Programming with Micro:bit](/exercises/microbit/level-3)
4. [Group Programming Challenge](/exercises/microbit/level-4)
5. [CodeClub Micro:bit Curriculum](/exercises/microbit/codeclub)
...
Looking for micro:bit single, double, or triple session workshops? See the [CodeClub Curriculum](/exercises/microbit/codeclub/) for project ideas, session flows, and external links to MakeCode tutorials and video demos.
