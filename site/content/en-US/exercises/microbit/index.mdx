...
## Sessions Included:
1. [Introduction to Micro:bit](./level-1/)
2. [Basic Programming with Micro:bit](./level-2/)
3. [Advanced Programming with Micro:bit](./level-3/)
4. [Group Programming Challenge](./level-4/)
5. [CodeClub Micro:bit Curriculum](./codeclub/)
...
Looking for micro:bit single, double, or triple session workshops? See the [CodeClub Curriculum](./codeclub/) for project ideas, session flows, and external links to MakeCode tutorials and video demos.
